        ...
        if ($user != null) {
            if (Hash::check($request->password, $user->password)) {
               ...
               // $tokenResult = $user->createToken('Personal Access Token');
                ...
                return response()->json(['result' => false, 'type' => "password", 'message' => 'password not matching, wrong password', 'user' => null], 401);
            }
        } else {
            return response()->json(['result' => false, 'type' => "mobile", 'message' => 'User not found, invalid number or email', 'user' => null], 401);
        }
