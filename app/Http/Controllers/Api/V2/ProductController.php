...
class ProductController extends Controller
{
    ...
    {
        return new ProductDetailCollection(Product::where('id', $id)->orWhere('slug', $id)->get());
    }
    ...
    {
        return new ProductMiniCollection(Product::inRandomOrder()
                ->limit(5)->get());
    }
    ...
    public function search(Request $request)
    {
        ...
        if ($request->categories != null && $request->categories != "" && $request->categories != 'undefined') {
            $category_ids = explode(',', $request->categories);
        }

        if ($request->brands != null && $request->brands != "" && $request->brands != 'undefined') {
