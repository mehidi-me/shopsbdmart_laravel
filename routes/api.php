...
Route::prefix('v2')->group(function () {
    ...
    Route::get('categories/all', 'Api\V2\CategoryController@all');
    ...
    Route::get('products/random', 'Api\V2\ProductController@random');
    ...
    Route::post('carts/remove', 'Api\V2\CartController@destroy');
    Route::get('carts/{user_id}', 'Api\V2\CartController@getList');
    ...
    Route::get('divisions', 'Api\V2\AddressController@getDivisions');
    Route::get('districts/{id}', 'Api\V2\AddressController@getDistricts');
    Route::get('upazilas/{id}', 'Api\V2\AddressController@getUpazilas');
